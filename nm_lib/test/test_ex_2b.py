...
def test_ex_2b():
    ...
    smaller_check = maxabserr < maxabserr_testing
    msg = f"Max absolute error at t={check_time:d} has changed for nints={nints[~close_check]}. {maxabserr[~close_check]} -> {maxabserr_testing[~close_check]}"
